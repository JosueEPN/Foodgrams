<template>
    <modal :show="show" @close="showModalPost" maxWidth="3xl" maxHeight="4x1">
        {{ post }}
        <div class="bg-white overflow-hidden shadow-none max-h-full m-2 p-2">
            <div class="grid grid-cols-3 min-w-full ">
                ...
                <div class="col-span-2  min-h-full ">
                    <header class="border-b border-grey-400">
                        <Link  :href="'/profile/'+$page.props.user.nick_name" class="block cursor-pointer py-4 flex items-center text-sm outline-none focus:outline-none focus:border-gray-300 transition duration-150 ease-in-out">
        ...
        <div class="pr-4 pl-4 border">
            ...
            <div class="pt-4 pb-1 pr-3">
                ...
                <div class="flex items-start">
                    <input @keyup.enter="comment($page.props.user.id)" v-model="text" class="w-full resize-none outline-none appearance-none" aria-label="Agrega un comentario..." placeholder="Agrega un comentario..."  autocomplete="off" autocorrect="off" style="height: 36px;"/>
